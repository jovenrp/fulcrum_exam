...
class _$SplashStateImpl implements _SplashState {
  _$SplashStateImpl({this.isLoading = false, this.isLoggedIn = false});
  ...
  @override
  String toString() {
    return 'SplashState(isLoading: $isLoading, isLoggedIn: $isLoggedIn)';
  }
...
abstract class _SplashState implements SplashState {
  factory _SplashState({final bool isLoading, final bool isLoggedIn}) =
      _$SplashStateImpl;
